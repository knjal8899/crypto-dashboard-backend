...
class TestQaApi(APITestCase):
    ...
    def test_price_question(self, mock_price):
        ...
        resp = self.client.get("/api/qa/query?text=What%20is%20the%20price%20of%20Bitcoin%3F")
    ...
    def test_trend_question(self, mock_hist):
        ...
        resp = self.client.get("/api/qa/query?text=Show%20me%20the%207-day%20trend%20of%20Ethereum")
        self.assertEqual(resp.status_code, 200)
